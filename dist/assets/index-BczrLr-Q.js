...
`;class W{constructor(e,t){n(this,"canvas");n(this,"backgroundColor");n(this,"device",null);n(this,"context",null);n(this,"renderPipeline",null);n(this,"quadVertexBuffer",null);n(this,"uniformBuffer",null);n(this,"uniformBindGroup",null);n(this,"sortIndexBuffer",null);n(this,"splatDataBuffer",null);n(this,"storageBindGroup",null);n(this,"lastSortOrder",null);n(this,"bindGroupNeedsUpdate",!1);n(this,"splatCount",0);n(this,"presentationFormat","bgra8unorm");this.canvas=e,this.backgroundColor=t||[1,1,1,1]}async initialize(){const e=await navigator.gpu.requestAdapter({powerPreference:"high-performance"});if(!e)throw new Error("WebGPU: No GPU adapter found");if(this.device=await e.requestDevice(),this.context=this.canvas.getContext("webgpu"),!this.context)throw new Error("WebGPU: Failed to get canvas context");this.presentationFormat=navigator.gpu.getPreferredCanvasFormat(),this.context.configure({device:this.device,format:this.presentationFormat,alphaMode:"opaque"}),this.createUniformBuffer(),this.createQuadVertexBuffer(),await this.createRenderPipeline()}createUniformBuffer(){if(!this.device)return;const e=160;this.uniformBuffer=this.device.createBuffer({label:"Uniform Buffer",size:e,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST})}createQuadVertexBuffer(){if(!this.device)return;const e=new Float32Array([-1,-1,-1,1,1,-1,1,1]);this.quadVertexBuffer=this.device.createBuffer({label:"Quad Vertex Buffer",size:e.byteLength,usage:GPUBufferUsage.VERTEX,mappedAtCreation:!0}),new Float32Array(this.quadVertexBuffer.getMappedRange()).set(e),this.quadVertexBuffer.unmap()}async createRenderPipeline(){if(!this.device)return;const e=this.device.createShaderModule({label:"3DGS Render Shader",code:N}),t=this.device.createBindGroupLayout({label:"Uniform Bind Group Layout",entries:[{binding:0,visibility:GPUShaderStage.VERTEX,buffer:{type:"uniform"}}]}),a=this.device.createBindGroupLayout({label:"Storage Bind Group Layout",entries:[{binding:0,visibility:GPUShaderStage.VERTEX,buffer:{type:"read-only-storage"}},{binding:1,visibility:GPUShaderStage.VERTEX,buffer:{type:"read-only-storage"}}]}),r=this.device.createPipelineLayout({label:"Render Pipeline Layout",bindGroupLayouts:[t,a]}),o=[{arrayStride:8,stepMode:"vertex",attributes:[{shaderLocation:0,offset:0,format:"float32x2"}]}];this.renderPipeline=this.device.createRenderPipeline({label:"3DGS Render Pipeline",layout:r,vertex:{module:e,entryPoint:"vertexMain",buffers:o},fragment:{module:e,entryPoint:"fragmentMain",targets:[{format:this.presentationFormat,blend:{color:{srcFactor:"src-alpha",dstFactor:"one-minus-src-alpha",operation:"add"},alpha:{srcFactor:"one",dstFactor:"one-minus-src-alpha",operation:"add"}}}]},primitive:{topology:"triangle-strip",stripIndexFormat:void 0},depthStencil:void 0}),this.uniformBindGroup=this.device.createBindGroup({label:"Uniform Bind Group",layout:t,entries:[{binding:0,resource:{buffer:this.uniformBuffer}}]})}loadSplatsFromPackedData(e,t,a){if(!this.device)throw new Error("Device not initialized");if(this.splatCount=t,(!this.splatDataBuffer||this.splatDataBuffer.size!==e.byteLength)&&(this.splatDataBuffer&&this.splatDataBuffer.destroy(),this.splatDataBuffer=this.device.createBuffer({label:"Splat Data Buffer",size:e.byteLength,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),this.bindGroupNeedsUpdate=!0),this.device.queue.writeBuffer(this.splatDataBuffer,0,e.buffer,e.byteOffset,e.byteLength),a){const r=a.byteLength,o=!this.lastSortOrder||a!==this.lastSortOrder;if((!this.sortIndexBuffer||this.sortIndexBuffer.size!==r)&&(this.sortIndexBuffer&&this.sortIndexBuffer.destroy(),this.sortIndexBuffer=this.device.createBuffer({label:"Sort Index Buffer",size:r,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),this.bindGroupNeedsUpdate=!0),o&&(this.device.queue.writeBuffer(this.sortIndexBuffer,0,a.buffer,a.byteOffset,a.byteLength),this.lastSortOrder=a),this.bindGroupNeedsUpdate&&this.renderPipeline&&this.sortIndexBuffer&&this.splatDataBuffer){const i=this.renderPipeline.getBindGroupLayout(1);this.storageBindGroup=this.device.createBindGroup({label:"Storage Bind Group",layout:i,entries:[{binding:0,resource:{buffer:this.sortIndexBuffer}},{binding:1,resource:{buffer:this.splatDataBuffer}}]}),this.bindGroupNeedsUpdate=!1}}}render(e,t,a){if(!this.device||!this.context||!this.renderPipeline||this.splatCount===0||!this.storageBindGroup)return;this.updateUniforms(e,t,a);const r=this.context.getCurrentTexture().createView(),o=this.device.createCommandEncoder({label:"Render Command Encoder"}),i=o.beginRenderPass({label:"Render Pass",colorAttachments:[{view:r,clearValue:{r:this.backgroundColor[0],g:this.backgroundColor[1],b:this.backgroundColor[2],a:this.backgroundColor[3]},loadOp:"clear",storeOp:"store"}]});i.setPipeline(this.renderPipeline),i.setBindGroup(0,this.uniformBindGroup),i.setBindGroup(1,this.storageBindGroup),i.setVertexBuffer(0,this.quadVertexBuffer),i.draw(4,this.splatCount),i.end(),this.device.queue.submit([o.finish()])}updateUniforms(e,t,a){if(!this.device||!this.uniformBuffer)return;const r=new ArrayBuffer(160),o=new Float32Array(r),i=new Uint32Array(r);o.set(e,0),o.set(t,16),o[32]=a[0],o[33]=a[1],i[36]=1,this.device.queue.writeBuffer(this.uniformBuffer,0,r)}dispose(){var e,t,a,r,o;(e=this.sortIndexBuffer)==null||e.destroy(),(t=this.splatDataBuffer)==null||t.destroy(),(a=this.quadVertexBuffer)==null||a.destroy(),(r=this.uniformBuffer)==null||r.destroy(),(o=this.device)==null||o.destroy(),this.sortIndexBuffer=null,this.splatDataBuffer=null,this.quadVertexBuffer=null,this.uniformBuffer=null,this.uniformBindGroup=null,this.storageBindGroup=null,this.device=null,this.context=null,this.renderPipeline=null}}let y=null,_=null,S=null,x=null,F=null,E=null;const M=2048,B=M-1;function D(d,e,t){const r=d.length/13;(!y||y.length!==r)&&(y=new Float32Array(r),_=new Uint32Array(y.buffer),S=new Uint32Array(r),x=new Uint32Array(r),F=new Uint32Array(r),E=new Uint32Array(M));const o=y,i=_,l=S,c=x,u=F,f=E,h=e[0],s=e[1],m=e[2],T=t[0],L=t[1],z=t[2];for(let p=0;p<r;p++){const w=p*13;o[p]=(d[w]-h)*T+(d[w+1]-s)*L+(d[w+2]-m)*z,l[p]=p}for(let p=0;p<r;p++){const w=i[p];i[p]=w^(-(w>>31)|2147483648)}P(i,l,c,f,0,r),P(i,c,l,f,11,r),P(i,l,c,f,22,r);for(let p=0;p<r;p++)u[p]=c[r-1-p];return u}function P(d,e,t,a,r,o){a.fill(0);for(let l=0;l<o;l++){const c=d[e[l]]>>r&B;a[c]++}let i=0;for(let l=0;l<M;l++){const c=a[l];a[l]=i,i+=c}for(let l=0;l<o;l++){const c=e[l],u=d[c]>>r&B;t[a[u]++]=c}}function Y(d,e){const a=e.length,r=new Float32Array(a*13);for(let o=0;o<a;o++){const l=e[o]*13,c=o*13;for(let u=0;u<13;u++)r[c+u]=d[l+u]}return r}class X{constructor(e){n(this,"renderer",null);n(this,"backend",null);n(this,"canvas");n(this,"options");n(this,"camera");n(this,"viewMatrix",null);n(this,"projectionMatrix",null);n(this,"originalPackedData",null);n(this,"sortMode","balance");n(this,"cachedSortOrder",null);n(this,"sortOrderComputed",!1);n(this,"renderTime",0);n(this,"sortTime",0);this.canvas=e.canvas,this.options=e,this.sortMode=e.sortMode||"balance";const t=e.camera||{position:[-.02,-.013,1.5],target:[0,0,0],fov:22,near:.01,far:100};this.camera={...t,up:[0,1,0],aspect:1}}async initialize(){const{preferBackend:e,backgroundColor:t}=this.options;if(e!=="webgl"&&await this.checkWebGPUSupport())try{this.renderer=new W(this.canvas,t),await this.renderer.initialize(),this.backend="webgpu",console.log("✅ Using WebGPU renderer"),this.updateCameraAspect();return}catch(r){console.warn("⚠️ WebGPU init failed, fallback to WebGL:",r)}this.renderer=new H(this.canvas,t),await this.renderer.initialize(),this.backend="webgl",console.log("✅ Using WebGL renderer"),this.updateCameraAspect()}loadSplatsFromPackedData(e){if(!this.renderer)throw new Error("Renderer not initialized");const t=this.originalPackedData&&this.originalPackedData.length===e.length;this.originalPackedData=e,t||(this.sortOrderComputed=!1,this.cachedSortOrder=null)}renderFrame(){if(!this.renderer||!this.originalPackedData)return;const e=performance.now();this.updateCameraMatrices();const t=Math.floor(this.originalPackedData.length/13);let a;if(this.sortMode==="quality"){const r=performance.now();a=D(this.originalPackedData,this.camera.position,this.getCameraForward()),this.sortTime=performance.now()-r}else this.sortTime=0,this.sortOrderComputed||(this.cachedSortOrder=D(this.originalPackedData,this.camera.position,this.getCameraForward()),this.sortOrderComputed=!0),a=this.cachedSortOrder;if(this.backend==="webgpu")this.renderer.loadSplatsFromPackedData(this.originalPackedData,t,a);else{const r=Y(this.originalPackedData,a);this.renderer.loadSplatsFromPackedData(r,t)}this.renderer.render(this.viewMatrix,this.projectionMatrix,[this.canvas.width,this.canvas.height]),this.renderTime=performance.now()-e}setSortMode(e){this.sortMode!==e&&(this.sortMode=e,this.sortOrderComputed=!1,this.cachedSortOrder=null,console.log(`🎨 Sort mode changed to: ${e}`))}getSortMode(){return this.sortMode}updateCamera(e){Object.assign(this.camera,e),this.updateCameraAspect()}handleResize(){this.updateCameraAspect()}getBackend(){return this.backend}dispose(){var e;(e=this.renderer)==null||e.dispose(),this.renderer=null}async checkWebGPUSupport(){if(!navigator.gpu)return!1;try{return await navigator.gpu.requestAdapter()!==null}catch{return!1}}updateCameraAspect(){this.camera.aspect=this.canvas.width/this.canvas.height}updateCameraMatrices(){this.projectionMatrix=this.createPerspectiveMatrix(this.camera.fov,this.camera.aspect,this.camera.near,this.camera.far),this.viewMatrix=this.createLookAtMatrix(this.camera.position,this.camera.target,this.camera.up)}getCameraForward(){const e=[this.camera.target[0]-this.camera.position[0],this.camera.target[1]-this.camera.position[1],this.camera.target[2]-this.camera.position[2]],t=Math.sqrt(e[0]**2+e[1]**2+e[2]**2);return t>0&&(e[0]/=t,e[1]/=t,e[2]/=t),e}createPerspectiveMatrix(e,t,a,r){const o=1/Math.tan(e*Math.PI/180/2),i=1/(a-r);return new Float32Array([o/t,0,0,0,0,o,0,0,0,0,(a+r)*i,-1,0,0,a*r*i*2,0])}createLookAtMatrix(e,t,a){const r=[e[0]-t[0],e[1]-t[1],e[2]-t[2]],o=Math.sqrt(r[0]**2+r[1]**2+r[2]**2);r[0]/=o,r[1]/=o,r[2]/=o;const i=[a[1]*r[2]-a[2]*r[1],a[2]*r[0]-a[0]*r[2],a[0]*r[1]-a[1]*r[0]],l=Math.sqrt(i[0]**2+i[1]**2+i[2]**2);i[0]/=l,i[1]/=l,i[2]/=l;const c=[r[1]*i[2]-r[2]*i[1],r[2]*i[0]-r[0]*i[2],r[0]*i[1]-r[1]*i[0]];return new Float32Array([i[0],c[0],r[0],0,i[1],c[1],r[1],0,i[2],c[2],r[2],0,-(i[0]*e[0]+i[1]*e[1]+i[2]*e[2]),-(c[0]*e[0]+c[1]*e[1]+c[2]*e[2]),-(r[0]*e[0]+r[1]*e[1]+r[2]*e[2]),1])}}const g={rendering:{backgroundColor:[1,1,1,1],sortMode:"balance"},camera:{position:[-.02,-.013,1.5],target:[0,0,0],fov:22,near:.01,far:100},animation:{fps:25,idleFile:"idle.pb",audioFile:"mono.pb",audioWavFile:"mono.wav"},avatar:{baseAssetsPath:"",modelFolder:"3dgs4",wasmPath:"/src/wasm/avatar_core_wasm.js"},wasm:{logLevel:"basic",enableValidation:!1,enablePerformanceMetrics:!0}};class Z{constructor(){n(this,"audio",null);n(this,"_isPlaying",!1);n(this,"fps",g.animation.fps);n(this,"onEndedCallback")}async initialize(e,t){return this.onEndedCallback=t,new Promise((a,r)=>{this.audio=new Audio(e),this.audio.addEventListener("canplaythrough",()=>{this.setupEventListeners(),a()},{once:!0}),this.audio.addEventListener("error",()=>{r(new Error(`Failed to load audio: ${e}`))},{once:!0}),this.audio.load()})}setupEventListeners(){this.audio&&(this.audio.addEventListener("play",()=>{this._isPlaying=!0}),this.audio.addEventListener("ended",()=>{var e;this._isPlaying=!1,(e=this.onEndedCallback)==null||e.call(this)}))}async play(){if(!this.audio)throw new Error("Audio not loaded");this.audio.currentTime=0,await this.audio.play()}stop(){this.audio&&(this._isPlaying=!1,this.audio.pause(),this.audio.currentTime=0)}isPlaying(){return this._isPlaying}getCurrentFrameIndex(){return this.audio?Math.floor(this.audio.currentTime*this.fps):0}dispose(){this.stop(),this.audio&&(this.audio.src="",this.audio=null),this.onEndedCallback=void 0}}class Q{constructor(){n(this,"avatarCore",null);n(this,"renderSystem",null);n(this,"animationPlayer",null);n(this,"animationLoopId",null);n(this,"animationStartTime",0);n(this,"onPlaybackEndedCallback")}async initialize(e){console.log("🚀 Initializing Avatar App...");try{await this.initializeAvatarCore(),await this.initializeRenderSystem(e),await this.renderFirstFrame(),this.startAnimationLoop(),console.log("✅ Avatar App initialized successfully"),console.log(`🎨 Rendering mode: ${this.renderSystem.getSortMode().toUpperCase()}`),this.renderSystem.getSortMode()==="balance"?console.log("  ↳ Balance mode: First-frame sorting, subsequent frames reuse cache"):console.log("  ↳ Quality mode: Every frame re-sorting")}catch(t){throw console.error("❌ Avatar App initialization failed:",t),t}}async initializeAvatarCore(){console.log("🔧 Initializing Avatar Core (main thread)..."),this.avatarCore=new G({logLevel:g.wasm.logLevel,enableValidation:g.wasm.enableValidation,enablePerformanceMetrics:g.wasm.enablePerformanceMetrics,baseAssetsPath:g.avatar.baseAssetsPath,modelFolder:g.avatar.modelFolder,wasmPath:g.avatar.wasmPath}),await this.avatarCore.initialize(),await this.avatarCore.loadCharacter(),await this.avatarCore.loadAnimation(),console.log("✅ Avatar Core initialized")}async initializeRenderSystem(e){this.renderSystem=new X({canvas:e,backgroundColor:g.rendering.backgroundColor,camera:g.camera,sortMode:g.rendering.sortMode}),await this.renderSystem.initialize()}async renderFirstFrame(){await this.renderFrame(0)}async renderFrame(e){if(!this.avatarCore||!this.renderSystem)return;const t=await this.avatarCore.computeCompleteFrameFlat({frameIndex:e});if(!t){console.warn("⚠️ No splat data returned from WASM");return}this.renderSystem.loadSplatsFromPackedData(t),this.renderSystem.renderFrame()}startAnimationLoop(){this.animationStartTime=Date.now(),this.animationLoop()}async animationLoop(){try{const e=this.getCurrentFrameIndex();await this.renderFrame(e)}catch(e){console.error("❌ Animation loop error:",e)}this.animationLoopId=requestAnimationFrame(()=>this.animationLoop())}getCurrentFrameIndex(){var t;if((t=this.animationPlayer)!=null&&t.isPlaying())return this.animationPlayer.getCurrentFrameIndex();const e=(Date.now()-this.animationStartTime)/1e3;return Math.floor(e*g.animation.fps)}stopAnimationLoop(){this.animationLoopId!==null&&(cancelAnimationFrame(this.animationLoopId),this.animationLoopId=null)}setOnPlaybackEnded(e){this.onPlaybackEndedCallback=e}async playAudioAnimation(){try{if(await this.avatarCore.switchAnimationFile(g.animation.audioFile),this.animationPlayer)this.animationPlayer.stop();else{const e=`/${g.avatar.modelFolder}/${g.animation.audioWavFile}`;this.animationPlayer=new Z,await this.animationPlayer.initialize(e,async()=>{this.animationPlayer.stop(),await this.avatarCore.switchAnimationFile(g.animation.idleFile),this.animationStartTime=Date.now(),this.onPlaybackEndedCallback&&this.onPlaybackEndedCallback()})}await this.animationPlayer.play()}catch(e){throw console.error("❌ Failed to play audio animation:",e),await this.avatarCore.switchAnimationFile(g.animation.idleFile),this.animationStartTime=Date.now(),e}}setSortMode(e){var t;(t=this.renderSystem)==null||t.setSortMode(e)}getSortMode(){var e;return((e=this.renderSystem)==null?void 0:e.getSortMode())||null}getRenderBackend(){var e;return((e=this.renderSystem)==null?void 0:e.getBackend())||null}getPerformanceStats(){var e,t,a;return{wasmTime:((e=this.avatarCore)==null?void 0:e.wasmTime)||0,renderTime:((t=this.renderSystem)==null?void 0:t.renderTime)||0,sortTime:((a=this.renderSystem)==null?void 0:a.sortTime)||0}}dispose(){var e,t;this.stopAnimationLoop(),(e=this.renderSystem)==null||e.dispose(),(t=this.avatarCore)==null||t.release()}}class J{constructor(){n(this,"loaderEl");n(this,"loaderMessage");n(this,"errorEl");n(this,"errorMessage");this.loaderEl=document.getElementById("loader"),this.loaderMessage=document.getElementById("loader-message"),this.errorEl=document.getElementById("error"),this.errorMessage=document.getElementById("error-message")}show(e="正在加载..."){this.loaderMessage.textContent=e,this.loaderEl.style.display="flex",this.errorEl.style.display="none"}hide(){this.loaderEl.style.display="none"}showError(e){this.loaderEl.style.display="none",this.errorEl.style.display="flex",this.errorMessage.textContent=e}}class K{constructor(e){n(this,"app");n(this,"controlsEl");n(this,"backendInfo");n(this,"backendBadge");n(this,"playBtn");n(this,"sortBtn");n(this,"isPlaying",!1);n(this,"sortMode","balance");this.app=e,this.controlsEl=document.getElementById("controls"),this.backendInfo=document.getElementById("backend-info"),this.backendBadge=document.getElementById("backend-badge"),this.playBtn=document.getElementById("play-btn"),this.sortBtn=document.getElementById("sort-btn"),this.playBtn.addEventListener("click",()=>this.handlePlay()),this.sortBtn.addEventListener("click",()=>this.handleToggleSortMode())}show(){var t;const e=((t=this.app.getRenderBackend())==null?void 0:t.toUpperCase())||"Unknown";this.backendBadge.textContent=e,this.backendBadge.className=`badge backend-${e.toLowerCase()}`,this.backendInfo.style.display="flex",this.sortMode=this.app.getSortMode()||"balance",this.sortBtn.textContent=this.sortMode==="quality"?"🎯 Quality":"⚡ Balance",this.controlsEl.style.display="flex"}hide(){this.controlsEl.style.display="none",this.backendInfo.style.display="none"}setOnPlaybackEnded(e){this.app.setOnPlaybackEnded(()=>{this.isPlaying=!1,this.playBtn.disabled=!1,this.playBtn.textContent="▶️ 播放",e()})}async handlePlay(){if(!this.isPlaying)try{this.isPlaying=!0,this.playBtn.disabled=!0,this.playBtn.textContent="播放中...",await this.app.playAudioAnimation()}catch(e){throw console.error("❌ 播放失败:",e),this.isPlaying=!1,this.playBtn.disabled=!1,this.playBtn.textContent="▶️ 播放",e}}handleToggleSortMode(){this.sortMode=this.sortMode==="balance"?"quality":"balance",this.app.setSortMode(this.sortMode),this.sortBtn.textContent=this.sortMode==="quality"?"🎯 Quality":"⚡ Balance",console.log(`🎨 排序模式切换: ${this.sortMode}`)}}class ee{constructor(e){n(this,"container");n(this,"fpsEl");n(this,"wasmEl");n(this,"renderEl");n(this,"sortEl");n(this,"frameCount",0);n(this,"lastFpsUpdate",0);n(this,"currentFps",0);n(this,"lastUpdate",0);n(this,"UPDATE_INTERVAL",1e3);this.container=document.getElementById(e),this.fpsEl=this.createStatItem("FPS","0"),this.wasmEl=this.createStatItem("WASM","0ms"),this.renderEl=this.createStatItem("Render","0ms"),this.sortEl=this.createStatItem("Sort","0ms"),this.container.appendChild(this.fpsEl),this.container.appendChild(this.wasmEl),this.container.appendChild(this.renderEl),this.container.appendChild(this.sortEl),this.sortEl.style.display="none"}createStatItem(e,t){const a=document.createElement("div");return a.className="stat-item",a.innerHTML=`
      <span class="stat-label">${e}:</span>
      <span class="stat-value">${t}</span>
    `,a}update(e,t,a){const r=performance.now();this.frameCount++,r-this.lastFpsUpdate>=1e3&&(this.currentFps=Math.round(this.frameCount*1e3/(r-this.lastFpsUpdate)),this.frameCount=0,this.lastFpsUpdate=r),!(r-this.lastUpdate<this.UPDATE_INTERVAL)&&(this.lastUpdate=r,this.updateValue(this.fpsEl,String(this.currentFps)),this.updateValue(this.wasmEl,this.formatTime(e)),this.updateValue(this.renderEl,this.formatTime(t)),a!==void 0?(this.sortEl.style.display="flex",this.updateValue(this.sortEl,this.formatTime(a))):this.sortEl.style.display="none")}updateValue(e,t){const a=e.querySelector(".stat-value");a&&(a.textContent=t)}formatTime(e){return e.toFixed(1)+"ms"}}const b=document.getElementById("canvas");let v;function C(){const d=window.devicePixelRatio||1,e=window.innerWidth,t=window.innerHeight;if(b.width=Math.floor(e*d),b.height=Math.floor(t*d),b.style.width=`${e}px`,b.style.height=`${t}px`,v){const a=v.renderSystem;a!=null&&a.handleResize&&a.handleResize()}}function te(d){function e(){if(!v)return;const t=v.getPerformanceStats(),a=v.getSortMode();d.update(t.wasmTime,t.renderTime,a==="quality"?t.sortTime:void 0),requestAnimationFrame(e)}requestAnimationFrame(e)}async function ae(){const d=new J;try{C(),d.show("正在加载 WASM..."),v=new Q,await v.initialize(b);const e=new K(v),t=new ee("performance-stats");e.setOnPlaybackEnded(()=>{console.log("✅ 播放完成")}),d.hide(),e.show(),document.getElementById("performance-stats").style.display="block",te(t),console.log("✅ Avatar App 初始化成功")}catch(e){console.error("❌ 初始化失败:",e),d.showError(e.message||"初始化失败")}}window.addEventListener("resize",C);window.addEventListener("orientationchange",C);window.addEventListener("DOMContentLoaded",ae);
